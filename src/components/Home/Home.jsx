         ...
         <div className="bg-white">
                <div className="max-w-2xl mx-auto py-6 px-4 sm:py-10 sm:px-6 lg:max-w-7xl lg:px-8">
                    <h2 className="sr-only">Books</h2>
                     {loading?<div className='view-h-25 flex items-center justify-center'><h1 className='text-2xl font-bold tracking-tight text-gray-900'><i className="fa-solid fa-spinner fa-spin"></i> Loading Popular books...</h1></div>: 
